...
import task_Polumestny_Andrey_inverted_index as inverted_index
...
def test_cli_query_from_file(capsys):
    ...
    with open(query_file, 'r') as query_file_in:
        inverted_index.query_from_file(inverted_index_path='datasets/inv_index_struct_test', query_file=query_file_in)
